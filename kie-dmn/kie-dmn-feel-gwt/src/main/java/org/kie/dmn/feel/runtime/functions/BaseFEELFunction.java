...
//        } else if (this instanceof MaxFunction) {
//            return doCata(ctx, invokeMaxFunction(params));
...
//                return ((MaxFunction) this).invoke((List) param);
//            }
//        }
//
//        return ((MaxFunction) this).invoke(params);
        return null;
    }
